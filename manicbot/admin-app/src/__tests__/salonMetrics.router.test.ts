...
const DDL_USERS = `CREATE TABLE users (
  ...
  dob TEXT, email TEXT, ig_username TEXT, notes TEXT, tags TEXT, marketing_contact_id INTEGER, email_opt_in INTEGER, email_prompt_last_at INTEGER, email_prompt_count INTEGER NOT NULL DEFAULT 0,
  ...
  last_visit_at INTEGER, avatar_emoji TEXT, avatar_url TEXT, avatar_r2_key TEXT,
