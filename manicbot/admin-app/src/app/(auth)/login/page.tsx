    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-950 px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl bg-slate-900 p-6 ring-1 ring-slate-800">
          ...
          {/* Google Sign In (only when provider is configured) */}
          {hasGoogle && (
            <>
              ...
              <button
                ...
                className="flex w-full items-center justify-center gap-2 rounded-lg bg-slate-800 py-2.5 text-sm font-medium text-white ring-1 ring-slate-700 transition hover:bg-slate-700"
              >
