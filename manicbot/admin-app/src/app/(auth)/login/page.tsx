...
export default function LoginPage() {
  ...
  return (
    <AuthShell
      badge="Web Access"
      title="Вход в кабинет, который ощущается частью ManicBot, а не отдельным темным экраном."
      description="Управляйте записями, каналами и командой в одном интерфейсе. Экран входа теперь визуально связан с лендингом и остается удобным даже с телефона."
      panelTitle="Войти в панель"
      panelDescription="Для владельцев салонов, мастеров и команды поддержки. Используйте email или быстрый вход через Google."
      footer={
