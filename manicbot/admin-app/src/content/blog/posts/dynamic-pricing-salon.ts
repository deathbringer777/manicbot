...
По нашим данным три типа правил дают максимум эффекта:
...
За нашими даними три типи правил дають максимум ефекту:
...
By our data three rule types deliver maximum impact:
...
Z naszych danych trzy typy reguł dają maksymalny efekt:
