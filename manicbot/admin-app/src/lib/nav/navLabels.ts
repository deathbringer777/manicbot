...
export const NAV_LABELS: Record<string, Record<string, string>> = {
  ru: {
    ...
    "Agents": "Агенты",
    "Billing": "Биллинг",
    "Grant Codes": "Промокоды",
    "Events": "Системные события",
    "Analytics Events": "Аналитика воронки",
    "Errors": "Ошибки",
    "System": "Система",
    ...
    "Platform Customers": "Клиенты платформы",
    "Blog": "Блог",
    "Messages": "Сообщения",
    // Salon nav
    "Services": "Услуги",
  ...
  ua: {
    ...
    "Agents": "Агенти",
    "Billing": "Білінг",
    "Grant Codes": "Промокоди",
    "Events": "Системні події",
    "Analytics Events": "Аналітика воронки",
    "Errors": "Помилки",
    "System": "Система",
    ...
    "Platform Customers": "Клієнти платформи",
    "Blog": "Блог",
  ...
  pl: {
    ...
    "Agents": "Agenci",
    "Billing": "Płatności",
    "Grant Codes": "Kody promo",
    "Events": "Zdarzenia systemowe",
    "Analytics Events": "Analityka lejka",
    "Errors": "Błędy",
    "System": "System",
    "Providers": "Dostawcy",
    "Settings": "Ustawienia",
    ...
    "Platform Customers": "Klienci platformy",
    "Blog": "Blog",
    "Messages": "Wiadomości",
    "Services": "Usługi",
    "Masters": "Mistrzowie",
  ...
  en: {
    ...
    "Platform Customers": "Platform customers",
    "Blog": "Blog",
    "Messages": "Messages",
    "Services": "Services",
    "Masters": "Masters",
