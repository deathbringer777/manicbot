/**
 * Search normalization utilities for admin-app (TypeScript).
 * Mirrors manicbot/src/lib/searchNormalize.js — keep in sync manually.
 */
 ...
 */
export function polishToCyrillic(text: string): string {
 ...
 */
export function buildSearchVariants(text: string): string[] {
  const lower = text.toLowerCase();
