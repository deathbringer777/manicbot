...
const manifest: PluginManifest = {
  ...
  name: {
    ru: "Выгрузка данных",
    ua: "Вивантаження даних",
    en: "Data Export",
    pl: "Eksport danych",
  },
  tagline: {
    ru: "Скачать CSV с клиентами, записями или задачами",
    ua: "Завантажити CSV з клієнтами, записами чи задачами",
    en: "Download CSV of clients, bookings, or tasks",
    pl: "Pobierz CSV z klientami, rezerwacjami lub zadaniami",
  },
  description: {
