...
const manifest: PluginManifest = {
  ...
  name: {
    ru: "Карта лояльности",
    ua: "Картка лояльності",
    en: "Loyalty Card",
    pl: "Karta lojalnościowa",
  },
  tagline: {
    ru: "6 визитов — седьмой бесплатно. Клиенты возвращаются",
    ua: "6 візитів — сьомий безкоштовно. Клієнти повертаються",
    en: "6 visits — 7th free. Clients come back",
    pl: "6 wizyt — 7. gratis. Klienci wracają",
  },
  description: {
