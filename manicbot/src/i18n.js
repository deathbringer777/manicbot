...
ru: {
  ...
  sysadm_no_access: '⚠️ Нет доступа к этой кнопке. Создатель платформы: задайте в Cloudflare Worker переменную <b>ADMIN_CHAT_ID</b> = ваш Telegram chat_id (узнать: @userinfobot).',
...
ua: {
  ...
  sysadm_no_access: '⚠️ Немає доступу. Створювач платформи: вкажіть у Cloudflare Worker змінну <b>ADMIN_CHAT_ID</b> = ваш Telegram chat_id (@userinfobot).',
...
en: {
  ...
  sysadm_no_access: '⚠️ No access. Platform creator: set <b>ADMIN_CHAT_ID</b> in Worker secrets to your Telegram chat_id (@userinfobot).',
...
pl: {
  ...
  sysadm_no_access: '⚠️ Brak dostępu. Twórca platformy: ustaw <b>ADMIN_CHAT_ID</b> w sekretach Worker na swój chat_id z Telegrama (@userinfobot).',
