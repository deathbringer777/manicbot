export default {
  ...
  reg_name_invalid: '🙂 Похоже, это не имя. Напиши, пожалуйста, как тебя зовут — например, Анна:',
  ...
  apt_blocked_no_show: '⚠️ К сожалению, онлайн-запись сейчас недоступна из-за пропущенных визитов. Пожалуйста, свяжитесь с салоном напрямую, чтобы записаться.',
