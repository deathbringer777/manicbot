export default {
  ...
  email_ask: '✉️ <b>Хочешь стать постоянным клиентом?</b>\n\nОставь email — и первым получай скидки, акции и новости салона. Отписаться можно в любой момент.',
  email_ask_btn: '✉️ Оставить email',
  email_decline_btn: 'Не сейчас',
  email_ask_prompt: '✍️ Напиши свой email одним сообщением:',
  email_invalid: '❌ Это не похоже на email. Попробуй ещё раз или нажми «Не сейчас».',
  email_thanks: '🎉 <b>Спасибо!</b>\n\nБудем присылать только полезное — скидки и новости. Отписаться можно в любой момент в меню.',
  email_declined: '👌 Хорошо! Если передумаешь — email всегда можно оставить позже.',
  email_optout_btn: '🔕 Отписаться от рассылки',
  email_optout_done: '✅ Готово. Больше не будем присылать письма. Захочешь вернуться — просто оставь email снова.',
